function [forwardPass] = run_one_forwardPass(n_Wru_v, n_Wrr_n, m_Wzr_n, n_x0_c, n_bx_1, m_bz_1, ...
    ...
    if ~strcmp(net_noise, 'default')
        net.noiseSigma = net_noise;
    end
    
    forwardPass = [];
    [forwardPass.n_r_t, forwardPass.m_z_t, forwardPass.n_r0_1, ...
        forwardPass.n_x_t, forwardPass.n_x0_1] = run_rnn(n_Wru_v, ...
        n_Wrr_n, m_Wzr_n, n_x0_c, n_bx_1, m_bz_1, net.dt, net.tau, ...
